...
class MyLocalisationEnregistrerWidget extends StatefulWidget {
  ...
  @override
  State<MyLocalisationEnregistrerWidget> createState() =>
      _MyLocalisationEnregistrerWidgetState();
}

class _MyLocalisationEnregistrerWidgetState
    extends State<MyLocalisationEnregistrerWidget> {
  @override
  void initState() {
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: RaisedButton(
                                              ...
                                              onPressed: () {
                                                print(widget.id);
                                                TempsLivNotifier.deleteAdress(
                                                    true, widget.id, context);
                                                //  press();
                                                // print(
                                                //     widget.idpanier);
                                                // viewModel
