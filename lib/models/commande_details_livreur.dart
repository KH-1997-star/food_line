...
List<CommandeDetailsLivreur> commandeDetailsLivreurFromJson(String str) =>
    List<CommandeDetailsLivreur>.from(
        json.decode(str).map((x) => CommandeDetailsLivreur.fromJson(x)));

String commandeDetailsLivreurToJson(List<CommandeDetailsLivreur> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class CommandeDetailsLivreur {
  ...
  factory CommandeDetailsLivreur.fromJson(Map<String, dynamic> json) =>
      CommandeDetailsLivreur(
